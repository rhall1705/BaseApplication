...
import personal.rowan.baseapplication.ui.fragment.BaseFragment;
...
public abstract class BaseDialogFragment
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		if (mShownFromFragment) {
			...
			if (fragment != null && fragment instanceof IDialogCallbacks) {
				mCallbacks = (IDialogCallbacks) fragment;
			} else {
				throw new IllegalStateException("The parent fragment cannot be null and must implement IDialogFragmentListener");
			}
		} else {
			if (activity != null && activity instanceof IDialogCallbacks) {
				mCallbacks = (IDialogCallbacks) activity;
			} else {
			...
			builder.setPositiveButton(positiveButtonText,
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int whichButton) {
							if (mCallbacks != null) {
								mCallbacks.onDialogPositiveClick(BaseDialogFragment.this);
							}
						}
					});
		}
			...
			builder.setNegativeButton(negativeButtonText,
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							if (mCallbacks != null) {
								mCallbacks.onDialogNegativeClick(BaseDialogFragment.this);
							}
						}
					});
		}
		...
		if (neutralButtonText != null) {
			builder.setNeutralButton(neutralButtonText,
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							if (mCallbacks != null) {
								mCallbacks.onDialogNeutralClick(BaseDialogFragment.this);
							}
						}
					});
		}
	...
	public void onDismiss(DialogInterface dialogInterface) {
		if (mCallbacks != null) {
			mCallbacks.onDialogDismiss(BaseDialogFragment.this);
		}
